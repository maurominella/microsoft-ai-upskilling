...
> Full runnable solution: [`solutions/ex4_pricing_server.py`](./solutions/ex4_pricing_server.py),
> [`solutions/ex4_sales_client.py`](./solutions/ex4_sales_client.py) and (bonus)
> [`solutions/ex4_media_server.py`](./solutions/ex4_media_server.py).

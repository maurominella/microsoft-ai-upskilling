...
| 4 | [Publish a Foundry agent to Agent 365](./labs/lab-01x04-publish-to-agents365.md) | A published, governed agent invoked with its own identity (app-only) | 20–25 min | Advanced |

...
Built from deck version **v2** — 97 slides, last saved 13 September 2026.
...
│   ├── 02-measure.html               slides 16–47  evaluators: quality, safety, agents, NLP, cloud, custom
│   ├── 03-generate.html              slides 48–62  Simulator, adversarial data, UPIA / XPIA
│   ├── 04-harden.html                slides 63–81  AI Red Teaming Agent, attack techniques, ASR
│   └── 05-code-appendix.html         slides 82–97  SDK code walkthroughs
├── build/
...
DECK="AI-Evaluation-in-Microsoft-Foundry (wn).v2.pptx" OUT=site python build/build_site.py
```
...
Deck: `AI-Evaluation-in-Microsoft-Foundry (wn).v2.pptx` — 97 slides, last saved 13 September 2026.
